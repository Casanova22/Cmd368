...
import d1.egul.cmd368longkhnh.databinding.ActivityGameBinding
import java.util.*
...
class GameViewActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        gWebView = _gameBinding.gameView
        ...
        if (savedInstanceState != null) {
            ...
            gWebView?.loadUrl("file:///android_asset/cubGame/dist/index.html?lang=" + Locale.getDefault().language)
